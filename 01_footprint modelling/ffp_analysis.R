...
#
#
# Input: airborne measurements file, prepared using prepare_grhart_file.R (.csv); 
# functions by Kljun et al. (2015) (.R)
#
# Output: for every measurement, a raster file with the contribution of every m-2 to the flux (.nc)
#------------------------------
...
for (i in 1:nrow(df3)){
  ...
  # Get measurement coordinates: lat lon point --> xy point (in rijksdriehoe coördinatenk):
