"""
This script takes a random sample of airborne data to have 20 random lat-lon locations,
and calculates the BBB, OWD and GWS values for these locations, for all the dates
that the OWASIS data is available for.

Input: all owasis data (.tiff), airborne data (.csv)

Output: dataframe with OWASIS values for every day the data is available for 20 
locations in the airborne data (.csv)
"""
...
# random sample of airborne data
